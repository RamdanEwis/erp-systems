...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"> الموردين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمه الموردين </span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table key-buttons text-md-nowrap">
                                            ...
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">المبلغ المستحق للمورد</th>
                    ...
                    <div class="modal-content modal-content-demo">
                        ...
                        <form method="post" action="{{route('suppliers.store')}}">
                            ...
                            <div class="modal-header">
                                <h6 class="modal-title">اضافه مورد</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>اسم المورد</label>
                                    <input  type="text" class="form-control" name="name" required autocomplete="اسم المورد" autofocus>
                                </div>
                                <div class="form-group">
                                    <label>المبلغ المستحق للمورد</label>
                                    <input  type="text" class="form-control" name="AmountDue" required autocomplete="اسم المورد" autofocus>
                                </div>
            ...
            <div class="modal" id="modaldemo15">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-content-demo">
                        ...
                        <form method="post" action="{{route('Payment_supplier')}}">

                            @csrf
                            <div class="modal-header">
                                <h6 class="modal-title"> دفعه الي  المورد</h6>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <form method="post" action="suppliers/update">
                                ...
                                @csrf
                                <div class="modal-header">
                                    <h6 class="modal-title"> تعديل المورد</h6>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>المبلغ المستحق للمورد</label>
                                        <input  type="text" id="AmountDue" class="form-control" name="AmountDue" required autocomplete="off" >
                                    </div>
                                    <div class="modal-footer">
                                        <button class="btn ripple btn-primary" type="submit">حفظ</button>
                                        <button class="btn ripple btn-secondary" data-dismiss="modal" type="button">اغلاق</button>
            ...
            <div class="modal" id="modaldemo10">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-content-demo">
                        ...
                        <form method="post" action="suppliers/destroy">
                            {{method_field('delete')}}
                            @csrf
                            <div class="modal-header">
                                <h6 class="modal-title"> هل انت متاكد من حذف المورد ؟</h6>
                                <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">

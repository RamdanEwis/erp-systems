                ...
                <div class="card overflow-hidden sales-card bg-primary-gradient">
                    <div class="pl-5 pt-5 pr-5 pb-3 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h1 class="tx-20 font-weight-bold mb-1 text-white text-center"
                                        style="padding-right: 82px;">الاقسام</h1>
                ...
                <div class="card overflow-hidden sales-card bg-warning-gradient">
                    <div class="pl-5 pt-5 pr-5 pb-5 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h1 class="tx-20 font-weight-bold mb-1 text-white" style="padding-right: 82px;">
                                        فاتوره شراء
                                    </h1>
                                    <p class="mb-0 tx-12 text-white op-7"></p>
                                </div>
                ...
                <div class="card overflow-hidden sales-card bg-danger-gradient">
                    <div class="pl-5 pt-5 pr-5 pb-5 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h1 class="tx-20 font-weight-bold mb-1 text-white" style="padding-right: 245px;">
                                        العملاء
                                    </h1>
                                    <p class="mb-0 tx-12 text-white op-7"></p>
                                </div>
                    ...
                    <div class="pl-5 pt-5 pr-5 pb-5 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                ...
                                <span class="float-right my-auto mr-auto">                                    <span class="text-white op-7"> </span>
                                </span>
                            </div>
                        </div>
                    </div>

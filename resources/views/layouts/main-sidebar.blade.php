    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @can('قائمة فواتير البيع')
                    <li><a class="slide-item" href="{{ url('/' . $page='invoicesSale') }}">قائمة فواتير البيع</a></li>
                    @endcan
                    @can('قائمة فواتير شراء')
                    <li><a class="slide-item" href="{{ url('/' . $page='invoiceBuy') }}">قائمة فواتير الشراء</a></li>
                    @endcan
                </ul>
            </li>
            @endcan

                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <a href="{{ route('invoiceSale.print', $invoices->id) }}" class="btn btn-primary btn-sm ml-auto"><i class="fa fa-print"></i>طباعه </a>
                            <a href="{{ route('invoiceSale.pdf', $invoices->id) }}" class="btn btn-secondary btn-sm ml-auto"><i class="fa fa-file-pdf"></i>تحميل  </a>
                        </div>
                    </div>
                </div>
            </div>
